...
const translations = {
  es: {
    ...
    modalInfoText: 'Serás redirigido al catálogo o archivo de <strong>{vendedor}</strong>.',
    cancelar: 'Cancelar',
    continuar: 'Continuar',
    modalWppTitle: '¿Ir a WhatsApp?',
    modalWppText: 'Vas a contactar a <strong>{vendedor}</strong> por WhatsApp para preguntar por "{producto}".',
  ...
  en: {
    ...
    modalInfoText: 'You will be redirected to the catalog or file of <strong>{vendedor}</strong>.',
    cancelar: 'Cancel',
    continuar: 'Continue',
    modalWppTitle: 'Go to WhatsApp?',
    modalWppText: 'You are about to contact <strong>{vendedor}</strong> on WhatsApp to ask about "{producto}".',
